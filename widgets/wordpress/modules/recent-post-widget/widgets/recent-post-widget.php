...
namespace CodexShaper\Framework\Widgets\Wordpress\Modules\RecentPostWidget\Widgets;
 ...
 * @since      1.0.0
 */
class RecentPostWidget extends WidgetBase {
	...
	public function get_name() {
		return 'zstal_recent_post_widget';
	}
	...
	public function get_title() {
		return __( 'Cxf Recent Post', 'codexshaper-framework' );
	}
